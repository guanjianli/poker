...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	return VSliderSkin;
})(eui.Skin);generateEUI.paths['resource/game_skins/main/MainPanelSkin.exml'] = window.MainPanelSkin = (function (_super) {
	__extends(MainPanelSkin, _super);
	var MainPanelSkin$Skin1 = 	(function (_super) {
		__extends(MainPanelSkin$Skin1, _super);
		function MainPanelSkin$Skin1() {
			_super.call(this);
			this.skinParts = [];
			...
			this.states = [
				new eui.State ("up",
					[
						...
						new eui.SetProperty("_Image1","scaleY",1)
					])
				,
				new eui.State ("down",
					[
		...
		var _proto = MainPanelSkin$Skin1.prototype;
		...
		return MainPanelSkin$Skin1;
	})(eui.Skin);

	function MainPanelSkin() {
		_super.call(this);
		this.skinParts = ["userInfo","mode_1","mode_2","mode_3","roomMode","myView"];
		
		this.height = 720;
		this.width = 1280;
		this.elementsContent = [this._UILayer1_i()];
		
		eui.Binding.$bindProperties(this, ["hostComponent.userName"],[0],this._Label1,"text")
	}
	var _proto = MainPanelSkin.prototype;

	_proto._UILayer1_i = function () {
		var t = new eui.UILayer();
		t.height = 720;
		t.touchEnabled = true;
		t.width = 1280;
		t.elementsContent = [this._Rect1_i(),this.myView_i()];
		return t;
	};
	_proto._Rect1_i = function () {
		var t = new eui.Rect();
		t.fillColor = 0xD2EBD8;
		t.percentHeight = 100;
		t.percentWidth = 100;
		t.y = 0;
		return t;
	};
	_proto.myView_i = function () {
		var t = new eui.Group();
		this.myView = t;
		t.touchEnabled = false;
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this.userInfo_i(),this.roomMode_i(),this._Button1_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.roomMode_i = function () {
		...
		t.percentWidth = 60;
		t.verticalCenter = -30;
		t.elementsContent = [this.mode_1_i(),this.mode_2_i(),this.mode_3_i()];
		return t;
	};
	_proto.mode_1_i = function () {
		var t = new eui.Group();
		this.mode_1 = t;
		t.horizontalCenter = 0;
		t.name = "picgrp";
	...
	_proto._Image4_i = function () {
		...
		t.source = "Hall_RoomName2_png";
		return t;
	};
	_proto.mode_2_i = function () {
		var t = new eui.Group();
		this.mode_2 = t;
	...
	_proto._Image6_i = function () {
		...
		t.source = "Hall_RoomName3_png";
		return t;
	};
	_proto.mode_3_i = function () {
		var t = new eui.Group();
		this.mode_3 = t;
		t.horizontalCenter = -250;
		t.percentWidth = 33;
	...
	_proto._Button1_i = function () {
		...
		t.horizontalCenter = 0;
		t.touchEnabled = true;
		t.skinName = MainPanelSkin$Skin1;
		return t;
	};
	return MainPanelSkin;
})(eui.Skin);generateEUI.paths['resource/game_skins/pork/card.exml'] = window.card = (function (_super) {
	...
	return card;
})(eui.Skin);generateEUI.paths['resource/game_skins/room/room.exml'] = window.room = (function (_super) {
	__extends(room, _super);
	function room() {
		_super.call(this);
		this.skinParts = ["myView"];
