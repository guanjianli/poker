...
define(function(require) {
	...
	// Default env
	var setTimer = function(f, ms) { return window.setTimeout(f, ms); };
	var clearTimer = function(t) { return window.clearTimeout(t); };
	var asap = function (f) { return window.setTimeout(f, 0); };
